...
\begin{figure}[h!]
	\centering
   	\includegraphics[width=0.60\textwidth]{images/bluetooth_hydro.jpg}
\end{figure}
\vspace{0.6 in}
\newpage
\vspace*{\fill}
\begingroup
{\centering \huge \color{accentcolor} \sc \Huge\textbf{\teamname \\ \productname} \par}
\vspace{0.5 in}
{\centering \large \sc \Large\textbf{\authors} \par}
\endgroup
\vspace*{\fill}
\newpage
...
\begin{versionhistory}
  	\vhEntry{0.1}{07.10.2020}{GG}{document creation}
  	\vhEntry{0.2}{07.10.2018}{GG|RB}{complete draft}
